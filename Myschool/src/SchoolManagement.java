...
public class SchoolManagement {
	...
	public static void main(String[] args) {
		...
		System.out.println("What you have to do is (Enter the Number) ? ");
			...
			if (choice.equalsIgnoreCase("1") || choice.equalsIgnoreCase("view") ) {
				...
				try {
				      ...
				      System.out.println("--------------------------------------------------------------");
					      ...
					      System.out.println("|Subject   | credit_hour      |");
					      System.out.println("-------------------------------");
					      while(rs.next()){
					         //Retrieve by column name
						     String subject = rs.getString("Subject");
					         String credit_hour = rs.getString("credit_hour");
			    ...
			    try{
			    	...
			    	subject = cin.nextLine();
			    	System.out.print("Enter Class Credit Hour : ");
			    	credit_hour = nic.nextLine();
